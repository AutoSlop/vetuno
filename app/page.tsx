...
const steps = [
  {
    ...
    desc: "Completa el formulario y te contactamos para mostrarte la plataforma en acción.",
  },
  {
    num: "2",
      ...
      <section className="relative overflow-hidden bg-gradient-to-b from-white to-bg">
        <div className="mx-auto max-w-6xl px-6 pb-20 pt-20 text-center md:pt-28">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a
              href="#demo"
              className="rounded-full bg-teal px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-teal/25 transition hover:bg-teal-dark hover:shadow-xl"
            >
              Solicitar demo
            </a>
            <a
