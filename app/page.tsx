        ...
        <div className="mx-auto max-w-6xl px-6 pb-20 pt-20 text-center md:pt-28">
          ...
          <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
            <a
              ...
              className="inline-flex items-center gap-3 rounded-full bg-teal px-8 py-3.5 text-base font-semibold text-white shadow-lg shadow-teal/25 transition hover:bg-teal-dark hover:shadow-xl"
            >
        ...
        <div className="mx-auto max-w-6xl px-6">
          <div className="grid items-center gap-12 md:grid-cols-2">
            ...
            <div className="rounded-2xl bg-white p-8 shadow-lg text-center">
              ...
              <p className="mb-6 text-text-light">Escríbenos por WhatsApp y agenda tu demo personalizada. Te respondemos en minutos.</p>
              <a
                href="https://wa.me/573145553305"
                target="_blank"
                rel="noopener noreferrer"
