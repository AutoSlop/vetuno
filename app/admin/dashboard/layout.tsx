  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      >
          ...
          <div className="space-y-1">
            {visibleNavItems.filter((i) => i.enabled).map((item) => (
              <Link
                ...
                style={isActive(item.href) ? { color: branding.primaryColor, backgroundColor: branding.primaryColor + "1A" } : undefined}
              >
        ...
        {/* Clinic contact info */}
        {(branding.phone || branding.email || branding.city) && (
          <div className="border-t border-gray-100 px-4 py-3">
            <p className="mb-1.5 text-[10px] font-semibold uppercase tracking-wider text-gray-400">Contacto clínica</p>
            {branding.phone && (
        ...
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-gray-200 bg-white px-4 lg:px-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="relative p-2 text-text-light hover:text-text transition">
              ...
              <span className="absolute right-1.5 top-1.5 h-2 w-2 rounded-full" style={{ backgroundColor: branding.secondaryColor }} />
            </button>
            {/* User avatar */}
